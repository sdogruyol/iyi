...
it uses, and iyi's own library is 9,516 lines rather than 8,161. The whole
...
program *has*: 8,161 lines of Crystal's standard library instead of 9,516
...
- **iyi's own library is 9,516 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 9,516 lines. `--crystal` swaps it for Crystal's |
