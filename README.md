...
it uses, and iyi's own library is 6,031 lines rather than 8,161. The whole
library is 224 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 224 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 6,031
...
- **iyi's own library is 6,031 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 6,031 lines. `--crystal` swaps it for Crystal's |
