...
it uses, and iyi's own library is 5,843 lines rather than 8,161. The whole
library is 216 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 216 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 5,843
...
- **iyi's own library is 5,843 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 5,843 lines. `--crystal` swaps it for Crystal's |
