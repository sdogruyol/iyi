...
it uses, and iyi's own library is 5,296 lines rather than 8,161. The whole
library is 192 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 192 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 5,296
...
- **iyi's own library is 5,296 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 5,296 lines. `--crystal` swaps it for Crystal's |
