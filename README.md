...
it uses, and iyi's own library is 5,292 lines rather than 8,161. The whole
library is 191 KB on disk beside the binary.
...
The tarball is relocatable and carries both libraries: iyi's own 191 KB, and
...
program *has*: 8,161 lines of Crystal's standard library instead of 5,292
...
- **iyi's own library is 5,292 lines, and its IO is `puts`, `print`,
...
| [`src/iyi`](src/iyi) | iyi's own library, 5,292 lines. `--crystal` swaps it for Crystal's |
