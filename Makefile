...
# beside `bin/iyi` is 376 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 376 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 376 KB: `iyi` installed as `bin/iyi` finds
