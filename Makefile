...
# beside `bin/iyi` is 379 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 379 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 379 KB: `iyi` installed as `bin/iyi` finds
