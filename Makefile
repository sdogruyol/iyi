...
# beside `bin/iyi` is 210 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 210 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 210 KB: `iyi` installed as `bin/iyi` finds
