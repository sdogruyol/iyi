...
case "$(uname -s)" in
  Darwin)
    allowed='___error|__tlv_bootstrap|_fcntl|_madvise|_pipe|_pthread_create|_pthread_kill|_sigaction|_sysctlbyname|__dyld_get_image_header|__dyld_get_image_vmaddr_slide|_clock_gettime_nsec_np|_exit|_kevent|_kqueue|_malloc|_memset|_mmap|_mprotect|_munmap|_pipe|_pthread_get_stackaddr_np|_pthread_self|_read|_realloc|_write'
