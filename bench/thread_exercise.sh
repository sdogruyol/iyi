...
case "$(uname -s)" in
  ...
  Darwin)
    ...
    runtime='___error __dyld_get_image_header __dyld_get_image_vmaddr_slide __tlv_bootstrap _clock_gettime_nsec_np _exit _kevent _kqueue _mmap _mprotect _munmap _pthread_get_stackaddr_np _pthread_self _write'
